  ...
  return (
    ...
    >
      <div className="flex flex-wrap justify-around w-full">
        <Card
          name="Tic Tac Toe"
          desc="The classic two-player game of X's and O's. Take turns marking spaces on a 3x3 grid, trying to get three in a row before your opponent. Simple rules, endless fun!"
          thumbnail={"/tictoe.png"}
          id={2}
        ></Card>
        <Card
          name="Space Wars"
